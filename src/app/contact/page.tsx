                ...
                {submitted ? (
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        className="flex items-center gap-2 px-8 py-3.5 bg-orange hover:bg-orange-hover text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-orange/20 active:scale-[0.98] text-sm"
                      >
                        <Send size={16} />
                        Send Message
                      </button>
